...
```bash
pip install git+ssh://git@github.com:stainless-sdks/Maisa-python.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/stainless-sdks/Maisa-python/actions/workflows/publish-pypi.yml). This will require a setup organization or repository secret to be set up.
